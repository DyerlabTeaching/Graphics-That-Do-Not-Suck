...
- One I use [coolors](https://coolors.co) to explore various themes.  

- There is a built-in plugin for [Color Brewer](https://colorbrewer2.org) that makes it easy to integrate (we will use this in `ggplot` graphics).  
...
## Boxplot - Information Dense {.smaller .scrollable}
